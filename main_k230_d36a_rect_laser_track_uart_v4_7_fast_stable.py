# -*- coding: utf-8 -*-
"""
K230 + D36A 二维步进云台黑色矩形视觉追踪 v4.7（最终矩形追踪版）
...
class K230RectangleStepperTrackerV31:
    ...
    def run(self):
        ...
        try:
            ...
            # 通道0：矩形检测，保持v4.7已经验证准确的320x240 RGB888 + cv_lite。
            ...
            print("=" * 76)
            print("K230 D36A rectangle tracker v4.7 FINAL-RECT started")
